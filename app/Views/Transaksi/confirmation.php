            ...
            if (jenis == 1) {
                ...
                if (type == 'pln') {
                    ...
                    if (customer_name == '') {
                        $("#info").hide();
                        $("#info").fadeIn(1000);
                        $("#info").html('<div class="alert alert-danger mb-3 mt-1 py-1 px5" role="alert">Mohon Cek ID terlebih dahulu!</div>')
                        return;
                    }
                }
            } else {
                ...
                if (customer_name == '') {
                    $("#info").hide();
                    $("#info").fadeIn(1000);
                    $("#info").html('<div class="alert alert-danger mb-3 mt-1 py-1 px5" role="alert">Cek Tagihan terlebih dahulu!</div>')
                    return;
                }
            }
            ...
            $.ajax({
                ...
                success: function(res) {
                    if (res.data.rc == "00") {
                        $("#info").hide();
                        $("#info").fadeIn(1000);
                        $("#info").html('<div class="alert alert-success mb-3 mt-1 py-1 px5" role="alert">' + res.data.name + '</div>')
                        ...
                        $("#info").hide();
                        $("#info").fadeIn(1000);
                        $("#info").html('<div class="alert alert-danger mb-3 mt-1 py-1 px5" role="alert">' + res.data.message + '</div>')
                    }
                },
                complete: function() {
                    $("button.cek").show();
