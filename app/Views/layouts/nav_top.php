		<b>
			<nav class="navbar navbar-dark table-light navbar-expand mr-auto ml-auto border-bottom p-0 fixed-top" style="max-width: 750px;min-width: <?= $min_width ?>;">
				<ul class="navbar-nav nav-justified w-100">
					...
					<li class="nav-item">
						<a href="<?= $this->BASE_URL ?>Home" class="nav-link text-secondary text-nowrap">
							<i class="fas fa-wallet"></i><br>Transaksi
						</a>
					</li>
					<li class="nav-item">
						<a href="<?= $this->BASE_URL ?>Akun" class="nav-link text-secondary text-nowrap"><i class="fas fa-user"></i></i><br>Akun</a>
					</li>
					<li class="nav-item">
