...
class Controller extends Public_Variables
{
    ...
    public function saldo()
    {
        ...
        $data['prepaid'] = $this->model('M_DB_1')->get_where('prepaid', "no_master = '" . $this->userData['no_master'] . "' ORDER BY insertTime DESC");
        ...
        $data['postpaid'] = $this->model('M_DB_1')->get_where('postpaid', "no_master = '" . $this->userData['no_master'] . "' ORDER BY insertTime DESC");
        ...
        $arr_manual_wd = array();
        $data['manual'] = $this->model('M_DB_1')->get_where('manual', "no_master = '" . $this->userData['no_master'] . "' ORDER BY insertTime DESC");
